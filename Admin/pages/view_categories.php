    ...
    <div class="page-content">
        <div class="card w-100">
            <div class="card-header">
                <h4 class="mb-0"><i class="fas fa-list me-2"></i>Categories Management</h4>
            </div>
            ...
            <div class="card-body">
                <table id="categoriesTable" class="table table-bordered table-striped table-hover">
                    ...
                    <?php
                    $q = mysqli_query($con, "SELECT c.*, b.brand_name FROM category_master c INNER JOIN brand_master b ON c.brand_id = b.brand_id ORDER BY c.category_id DESC");
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <img src="./images/category_images/<?= $row['category_image']; ?>"
                                    class="category-img"
                            ...
                            <td>
                                ...
                                <?php if ($row['is_active']): ?>
                                    <a href="toggle_category.php?id=<?= $row['category_id']; ?>&status=0"
                                ...
                                <?php else: ?>
                                    <a href="toggle_category.php?id=<?= $row['category_id']; ?>&status=1"
